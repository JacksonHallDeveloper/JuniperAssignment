...
{
    public class UnitedStatesLineItemDetailDto
    {
        ...
        public double special_district_taxable_amount { get; set; } // 0.0,
        public double special_tax_rate { get; set; } // 0.0,
        public double state_amount { get; set; } // 0.99,
        public double state_sales_tax_rate { get; set; } // 0.06625,
        public double state_taxable_amount { get; set; } // 15.0,
        public double tax_collectable { get; set; } // 0.99,
        public double taxable_amount { get; set; } // 15.0
    }
}